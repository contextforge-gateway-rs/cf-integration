...
|---|---:|---:|---:|---:|---:|
| Fixture direct | 38 | 2 | 0 | 0 | 0 |
| Control plane | 4 | 36 | 0 | 0 | 0 |
| Dataplane | 3 | 37 | 0 | 0 | 0 |
...
| http-header-validation | failure | failure | failure | shared failure | [SEP-2243-Server-Validation](https://modelcontextprotocol.io/specification/draft/basic/transports#server-validation)<br>[RFC-9110-5.5-Field-Values](https://www.rfc-editor.org/rfc/rfc9110#section-5.5)<br>[SEP-2243-Case-Sensitivity](https://modelcontextprotocol.io/specification/draft/basic/transports#case-sensitivity) |
