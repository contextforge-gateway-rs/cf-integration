...
| preservation.tool-result | Gateway preservation | passed | [MCP 2025-11-25](https://modelcontextprotocol.io/specification/2025-11-25/server/tools) | tool result shape preserved for "fast-time-echo" |
...
| preservation.tools-list | Gateway preservation | passed | [MCP 2025-11-25](https://modelcontextprotocol.io/specification/2025-11-25/server/tools) | validated 6 tool definitions |
...
| transport.malformed-json | HTTP transport | passed | [MCP 2025-11-25](https://modelcontextprotocol.io/specification/2025-11-25/basic/transports) | malformed JSON returned HTTP error 415 |
